...
git clone https://github.com/75-Sunny/bintel-05-storytelling

cd bintel-05-storytelling
code .
```
...
![Total Sales by Region](.docs/images/storytelling_category_sales_miller.png)
